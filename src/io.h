...
static bool has_extension(const char * filename,
  const char * ext) {
...
int tiffout(uint8_t * Rband, uint8_t * Gband, uint8_t * Bband, uint32_t dim, const char * filename);
...
// Magma colormap by Nathaniel J. Smith, Stefan van der Walt
// reformatted for use in C by David Basler
// The colormap was released under the CC0 license /public domain dedication. 
// see https://github.com/BIDS/colormap/blob/master/colormaps.py
static const double colormapMagma [][3]  =
        {
